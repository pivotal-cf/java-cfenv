...
If you are creating a user-provided-service in order to connect to a database by jdbc, you will want to provide a uri property along with username and password in the credentials block.
